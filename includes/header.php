        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-3">
                    ...
                    <li class="nav-item"><a class="nav-link <?php echo $currentPage == 'contact.php' ? 'activeLink' : ''; ?>" href="contact.php">Reserve book</a></li>
                    ...
                    <?php else: ?>
                        <li class="nav-item"><a class="btn btn-outline-dark rounded-pill px-4" href="signin.php">User Sign In</a></li>
                    <?php endif; ?>
